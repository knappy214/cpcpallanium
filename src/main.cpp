...
uint256 hashGenesisBlock("0x6c0880fc4719bf4f7a71fa76fc47784f9137b9b5f906a6006078f92dd9372e26");
...
const string strMessageMagic = "CppCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CppCoin: 1 days
static const int64 nTargetSpacing = 120; // CppCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cppcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CppCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is the Artificial Intelligence CPCPALLANIUM coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478115852; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2109125;
        ...
        assert(block.hashMerkleRoot == uint256("0x221d6d9b961bc6353ad9b97876e5eac3db510c2db697c094d8dc656ea7f4c306"));
